...
class CommandRepository {
  static const Map<String, List<int>> _irCodes = {
    ...
    'BAIRD_T15011DLEDDS_RC-6, Cranker_generic, SWEEX_Generic_Monitor, Westinghouse_RMT-13':
        [0x01FE10EF],
    'Manta_TV_2, RCA_RT2471_AC, RCA_TV_2': [0xA05F5FA0],
    'Enseo, Enseo_full': [0x6E9102FD],
    'Grandin_Unknown_Model, Kogan_KALED50XU9210STB, Oky_TV, Strong_TVD221_B1825, Supra_STV_LC32T880WL_1, Toshiba_32AV502U, Toshiba_CT-32F2, Toshiba_CT-90325, Toshiba_CT-9922, Toshiba_SE_R0305_32CV100U, United_tv':
        [0x40BF12ED],
    'BUSH_TV_VL32HDLED': [0x08F7D728],
    'ContinentalEdison_CELED32JBL7, Sencor_25801': [0x40BF0BF4],
    'Medion_MD21302': [0x19E618E7],
    'Android_TV_MXQ': [0x01FE40BF],
    'Grandin': [0x807F12ED],
    'CCE_RC512_Remote': [0x04FB40BF],
    'AORUS_Monitor': [0x00FF1AE5],
    'Sharp_g0684cesa_NES_TV': [0x28D70BF4],
    'NEC_E425': [0x38C701FE],
    'Sanyo_DP26640': [0x38C712ED],
    'Hitachi_LE46H508': [0x50AF17E8],
    'Strong_RCU-Z400N': [0xA05F1CE3],
    'Strong_STR7004': [0x01FE1CE3],
    'Daewood_Parsed': [0x807F827D],
    'Samsung': [0xE0E040BF, 0xE0E0807F],
    'LG': [0x20DF10EF],
    'Sony': [0xA90F04FB],
    'Panasonic': [0x40040109],
    'Toshiba': [0xF20D04FB],
    'Sharp': [0xAA5504FB],
    'Vizio': [0x703AC03F],
    'Hisense': [0x4CB304FB],
